...
Scenario: 역 사이에 새로운 역을 등록한다.
  ...
  And 구간의 거리에서 추가된 구간의 거리를 뺀 나머지를 추가된 역과의 거리로 설정된다.
...
![add station1](https://nextstep-storage.s3.ap-northeast-2.amazonaws.com/be71b2febc0c4d179c6606f9fe1a473b)

#### 새로운 역을 상행 종점으로 등록할 경우

![add station2](https://nextstep-storage.s3.ap-northeast-2.amazonaws.com/2d4654cc24f949c1818773df2ae57890)

#### 새로운 역을 하행 종점으로 등록할 경우

![add station3](https://nextstep-storage.s3.ap-northeast-2.amazonaws.com/832a8b49635c40b58f16fae1726909f6)

### 구간 등록 시 예외 케이스를 고려하기

#### 역 사이에 새로운 역을 등록할 경우 기존 역 사이 길이보다 크거나 같으면 등록을 할 수 없음

![exception1](https://nextstep-storage.s3.ap-northeast-2.amazonaws.com/13caad00374843038e304096afa418e4)

#### 상행역과 하행역이 이미 노선에 모두 등록되어 있다면 추가할 수 없음

* 아래의 이미지 에서 A-B, B-C 구간이 등록된 상황에서 B-C 구간을 등록할 수 없음(A-C 구간도 등록할 수 없음)

![exception2](https://nextstep-storage.s3.ap-northeast-2.amazonaws.com/ba4d3fa0fc86494e9e0011fdd341fbde)

#### 상행역과 하행역 둘 중 하나도 포함되어있지 않으면 추가할 수 없음

![exception3](https://nextstep-storage.s3.ap-northeast-2.amazonaws.com/bf2f852db58b43fca17293bb1ba4f131)
