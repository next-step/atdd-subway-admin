...
class SectionAcceptanceTest {
    ...
    private void setUp() {
        ...
        이호선.put("upStationId", STATION_IDS.get("당산역"));
        이호선.put("downStationId", STATION_IDS.get("사당역"));
    ...
    void addSection() {
        ...
        //then
        assertThat(ExtractUtils.extractNames(response)).containsExactly("당산역", "신도림역", "사당역");
        assertThat(ExtractUtils.extract("stations.distance", response, Integer.class)).contains(0, 10, 30);
