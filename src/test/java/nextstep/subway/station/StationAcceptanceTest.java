...
import static nextstep.subway.utils.StationTestCommon.*;
...
public class StationAcceptanceTest extends AcceptanceTest {
    ...
    void createStationWithDuplicateName() {
        ...
        // when
        ExtractableResponse<Response> response = 지하철_역_생성_요청(params.get("name"));
    ...
    void getStations() {
        ...
        ExtractableResponse<Response> createResponse1 = 지하철_역_생성_요청(params1.get("name"));

        Map<String, String> params2 = new HashMap<>();
        params2.put("name", "역삼역");
        ExtractableResponse<Response> createResponse2 = 지하철_역_생성_요청(params2.get("name"));
    ...
    void deleteStation() {
        ...
        Map<String, String> params = new HashMap<>();
        params.put("name", "강남역");
        ExtractableResponse<Response> createResponse = 지하철_역_생성_요청(params.get(0));
