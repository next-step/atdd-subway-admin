...
public class StationAcceptanceTest extends AcceptanceTest {
    ...
    void getStations() {
        /// given
        Map<String, String> params1 = generateParams("강남역");
        ...
        Map<String, String> params2 = generateParams("역삼역");
    ...
    public static Map<String, String> generateParams(String name) {
        Map<String, String> params = new HashMap<>();
        params.put("name", name);
        return params;
    }

    public static ExtractableResponse<Response> post(Map<String, String> params) {
