...
public class StationAcceptanceStep {
    ...
    public static void 지하철_역_목록_포함됨(ExtractableResponse<Response> createResponse1, ExtractableResponse<Response> createResponse2, ExtractableResponse<Response> response) {
