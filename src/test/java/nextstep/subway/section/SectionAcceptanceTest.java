...
public class SectionAcceptanceTest extends AcceptanceTest {
    ...
    void 지하철_구간_생성_실패_구간에_등록하려는_역이_존재_하지_않는_역의_경우() {
        ...
        // when
        // 지하철_구간_생성_요청
        ExtractableResponse<Response> 구간_추가_요청_실패_응답 = 구간_추가_요청(ID_추출(신분당선_생성_응답), 강남역_번호, "99", "5");
    ...
    void 지하철_역들이_구간에_모두_등록되지_않은_경우() {
        ...
        // when
        // 지하철_구간_생성_요청
        ExtractableResponse<Response> 구간_추가_요청_실패_응답 = 구간_추가_요청(ID_추출(신분당선_생성_응답), 광교역_번호, 미금역_번호, "5");
