...
public class SectionAcceptanceTest extends AcceptanceTest {
  ...
  private void 지하철_구간_등록됨(ExtractableResponse<Response> result, Long lineId) {
    ...
    assertThat(lineStationIds).isEqualTo(Stream.of(강남역_ID, 판교역_ID, 광교역_ID).collect(Collectors.toList()));
  }
}
