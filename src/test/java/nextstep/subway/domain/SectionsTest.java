...
class SectionsTest {
    ...
    void 구간_목록을_조회할_수_있어야_한다() {
        // given
        final Sections sections = new Sections();
        final Section section1 = new Section(line, finalUpStation, finalDownStation, lineDistance);
        final Section section2 = new Section(line, finalUpStation, newStation, 10L);
