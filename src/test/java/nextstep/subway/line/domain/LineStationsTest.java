...
public class LineStationsTest {
    ...
    void sortTest() {
        LineStation 이호선_강남역 = LineStation.createLineStation(강남역, null, 선릉역, 5); // 기점
        LineStation 이호선_선릉역 = LineStation.createLineStation(선릉역, 강남역, 잠실역, 10);
        LineStation 이호선_잠실역 = LineStation.createLineStation(잠실역, 선릉역, 왕십리역, 15);
        LineStation 이호선_왕십리역 = LineStation.createLineStation(왕십리역, 잠실역, null, 0); // 종점
