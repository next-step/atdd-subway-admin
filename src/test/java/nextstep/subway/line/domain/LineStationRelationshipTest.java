...
class LineStationRelationshipTest {
	...
	void saveInitData() {
		...
		이호선.addSection(강남역, 삼성역, 10);
		오호선.addSection(천호역, 군자역, 10);
	...
	void saveLineStation_shouldException1() {
		...
		assertThatThrownBy(() -> 이호선.addSection(역삼역, 선릉역, 6))
	...
	void saveLineStation_shouldException2() {
		...
		assertThatThrownBy(() -> 이호선.addSection(역삼역, 선릉역, 7))
			.isInstanceOf(IllegalArgumentException.class);
	}
	...
	void saveLineStation_shouldException4() {
		assertThatThrownBy(() -> 이호선.addSection(교대역, 잠실역, 7))
			.isInstanceOf(IllegalArgumentException.class);
	}
