...
import nextstep.subway.line.domain.sections.OriginalSectionCalculator;
...
class OriginalSectionCalculatorTest {
    ...
    void addSectionWithUpStationTest() {
        ...
        OriginalSectionCalculator.ADD_WITH_UP_STATION.calculate(originalSection, addSection);
