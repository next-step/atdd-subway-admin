...
public class LineTestFixture {
    ...
    public static LineRequest 신분당선_요청_데이터(StationResponse upStationResponse, StationResponse downStationResponse) {
        return new LineRequest("신분당선", "bg-red-600", upStationResponse.getId(), downStationResponse.getId(), 10);
    }

    public static LineRequest 구분당선_요청_데이터(StationResponse upStationResponse, StationResponse downStationResponse) {
        return new LineRequest("구분당선", "bg-blue-600", upStationResponse.getId(), downStationResponse.getId(), 5);
    }

    public static LineRequest 이호선_요청_데이터(StationResponse upStationResponse, StationResponse downStationResponse) {
