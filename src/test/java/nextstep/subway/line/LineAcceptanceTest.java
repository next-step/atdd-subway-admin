...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void getLines() {
        ...
        // given
        // 지하철_노선_등록되어_있음
        expected.add(LineAcceptanceUtil.지하철_노선_생성_아이디_조회(LineAcceptanceUtil.지하철_노선_생성_요청("신분당선", "bg-red-600")));
        expected.add(LineAcceptanceUtil.지하철_노선_생성_아이디_조회(LineAcceptanceUtil.지하철_노선_생성_요청("2호선", "bg-green-600")));
