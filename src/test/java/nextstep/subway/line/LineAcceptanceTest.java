...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void getLine() {
        ...
        ExtractableResponse<Response> response = LineTestApi.지하철_노선_조회_요청("/lines/" + lineIds.get(0));
    ...
    void deleteLine() {
        ...
        // 지하철_노선_제거_요청
        List<Long> lineIds = expectedIdList(createResponse);
        ExtractableResponse<Response> response = LineTestApi.지하철_노선_제거_요청("/lines/" + lineIds.get(0));
