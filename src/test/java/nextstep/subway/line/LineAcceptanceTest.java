...
import static nextstep.subway.line.LineCRUD.지하철노선_아이디로_삭제;
...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        신분당선 = new LineRequestDto("신분당선", "bg-red-600", upStationId, downStationId, 10);

        Long downStationId2 = 지하철역_생성("또다른지하철역");
        분당선 = new LineRequestDto("분당선", "bg-green-600", upStationId, downStationId2, 10);
    }
    ...
    void 지하철노선_수정() {
        ...
        // When
        UpdateLineRequestDto request = new UpdateLineRequestDto(다른분당선, "bg-red-600");
