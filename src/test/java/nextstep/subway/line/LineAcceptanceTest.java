...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLine2() {
        ...
        // then
        노선_등록_실패(노선_등록_응답, HttpStatus.BAD_REQUEST);
    }
    ...
    void getLine() {
        ...
        // then
        노선_등록_실패(노선_조회_응답, HttpStatus.OK);
    }
    ...
    void updateLine() {
        ...
        // when
        ExtractableResponse<Response> 노선_수정_요청_응답 = 지하철_노선_수정_요청(노선_수정_파라미터, 노선ID);

        // then
        노선_수정_성공(노선_수정_파라미터, 노선_수정_요청_응답);
    }
    ...
    void deleteLine() {
        // given
        // when
        ExtractableResponse<Response> 노선_제거_응답 = 지하철_노선_제거_요청(노선ID);

        // then
        노선_등록_실패(노선_제거_응답, HttpStatus.NO_CONTENT);
    }
