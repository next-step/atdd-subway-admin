...
public class DistanceTest {
    ...
    void newSectionDistanceTest() {
        ...
        assertThat(distance.compareTo(new Distance(3))).isEqualTo(new Distance(7));
    }
    ...
    void newSectionDistanceExceptionTest() {
        Distance distance = new Distance(10);
        assertThatThrownBy(() -> distance.compareTo(new Distance(10)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> distance.compareTo(new Distance(12)))
                .isInstanceOf(IllegalArgumentException.class);
    }
