...
public class LineAcceptanceTestUtils {
    ...
    static final String LINE_BASE_URL = "/lines";
    ...
    public static Response 지하철_노선_조회_요청(final Long id) {
        return get(LINE_BASE_URL, id).extract().response();
    }

    public static Response 지하철_노선_수정_요청(final Long id, final UpdateLineRequest updateLineRequest) {
        return put(LINE_BASE_URL, id, updateLineRequest).extract().response();
    }

    public static Response 지하철_노선_삭제_요청(final Long id) {
