...
public class LineService {
    ...
    @Transactional
    public SectionResponse registerSection(final Long lineId, final SectionRequest sectionRequest) {
        final Line line = getLineOrElseThrow(lineId);
        final SectionResponse sectionResponse = line.registerSection(
