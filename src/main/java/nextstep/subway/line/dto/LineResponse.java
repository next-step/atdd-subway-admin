...
public class LineResponse {
    ...
    public static LineResponse of(Line line) {
        return new LineResponse(line.getId(), line.getName(), line.getColor(), line.getUpToDownSortedStations(), line.getCreatedDate(), line.getModifiedDate());
    }
    ...
    private LineResponse(Long id, String name, String color, List<Station> stations, LocalDateTime createdDate, LocalDateTime modifiedDate) {
        ...
        this.name = name;
        this.color = color;
        this.stations = convertStationResponses(stations);
