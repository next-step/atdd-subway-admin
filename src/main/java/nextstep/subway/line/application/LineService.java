...
public class LineService {
    ...
    public LineResponse saveLine(LineRequest request) {
        ...
        Station firstStop = stationService.findById(request.getUpStationId());
        Station lastStop = stationService.findById(request.getDownStationId());
        sectionService.saveDefaultSections(persistLine, firstStop, lastStop, request.getDistance());
