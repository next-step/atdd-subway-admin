...
public class ContainsStationAnySpecification implements Predicate<List<Section>> {
    private Station upStation;
    private Station downStation;

    public ContainsStationAnySpecification(Station upStation, Station downStation) {
