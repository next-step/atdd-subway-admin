...
### 시나리오 Todo-list
  ...
  - [ ] 시나리오3
    - [ ] Sections에서 하행 종점역 구간을 찾는 기능 구현
    - [ ] Line에서 새로운 구간을 추가하기 전 신규 구간이 하행 종점역 교체인지 확인
    - [ ] 상행 종점역 추가, 하행 종점역 추가가 아닌 경우에만 일반적인 구간 추가 작업을 진행하도록 구현