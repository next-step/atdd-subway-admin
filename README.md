...
- [ ] 구간이 하나인 노선에서 역을 제거하는 경우 제거할 수 없다.

### 인수 테스트
- [ ] 구간이 하나인 노선에서는 역을 제거할 수 없다.
- [ ] 구간에 포함되지 않는 역은 제거할 수 없다.
- [ ] 구간이 두개 이상인 노선에서 상행 종점을 제거하면 다음 역이 상행 종점이 된다.
- [ ] 구간이 두개 이상인 노선에서 하행 종점을 제거하면 다음 역이 하행 종점이 된다.
- [ ] 구간이 세개인 노선에 가운데 역을 제거할 수 있다.
