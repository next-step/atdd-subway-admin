...
- [ ] 구간 등록하기 기능
  ...
  - [ ] 기능 구현
    - [ ] 케이스1. 구간 요청 DTO 하행과 기존 구간 데이터의 상행 동일
    - [ ] 케이스2. 구간 요청 DTO 상행과 기존 구간 데이터의 하행 동일
    - [ ] 케이스3. 구간 요청 DTO 상행과 기존 구간 데이터의 상행 동일
    - [ ] 케이스4. 구간 요청 DTO 하행과 기존 구간 데이터의 하행 동일
    - [ ] 예외1. 구간에 중간 역 추가시 부족한 역간 거리
    - [ ] 예외2. 연결 되지 않은 구간 등록
    - [ ] 예외3. 이미 등록된 구간 등록
