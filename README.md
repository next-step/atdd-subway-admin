...
### 기능 구현 순서
* [x] 인수 테스트 코드 작성
    * [x] 구간 제거 기능 시나리오별 인수 테스트 코드 작성
    * [x] 구간 제거 기능 예외 처리 인수 테스트 코드 작성
* [ ] 기능 구현
    * [ ] 구간 제거 기능 개발
        * [x] 상행 종점 제거
            * [x] 입력된 지하철역이 상행 종점역인지 확인
            * [x] 입력한 지하철역을 상행 지하철역으로 가진 lineStation 객체 찾기
            * [x] lineStation의 상행 지하철역, 구간 거리 update
            * [x] 기존 상행 종점역 lineStation delete
        * [x] 하행 종점으로 제거.
            * [x] 입력된 지하철역이 하행 종점역인지 확인
            * [x] 입력한 종점역을 하행으로 가진 lineStation 객체 delete
        * [x] 구간 사이의 역 제거
            * [x] 입력된 지하철역을 하행 지하철역으로 가진 lineStation 확인 및 구간 거리 구하기
            * [x] 입력된 지하철역을 상행 지하철역으로 가진 lineStation 확인 및 구간 거리 구하기
            * [x] 입력된 지하철열을 하행 지하철역으로 가진 lineStation 기준으로 하행 지하철역 및 구간 거리 update
            * [x] 입력된 지하철역을 상행 지하철역으로 가진 lineStation delete
    * [x] 구간 제거 기능 예외 처리
        * [x] 존재하지 않는 노선의 구간을 삭제 요청
        * [x] 노선에 포함되어 있지 않은 지하철역 구간을 삭제 요청
        * [x] 구간이 하나만 존재하는 구간의 지하철역 구간을 삭제 요청
